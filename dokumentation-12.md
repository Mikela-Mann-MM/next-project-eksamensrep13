...
vue vs react - hvad er der mest efterspørgsel på ude i den virkelige verden. Hvilket bibliotek har det største økosystem - moduler, pakker etc? Største community(søge hjælp hos)? 
...
## Perspektivering 
argumenter: kode-struktur, små genbrugelige komponenter af funktioner, navngivningskonventioner, platform til production miljø. 
god navngivningskonvention,funktioners navne giver mening ift hvad deres opgave er komponentersnavne skal give mening,  - mappestruktur skal give mening. nemt for et team at arbejde på projektet. 

vercel - håndtere traffik - vælge den rigtige platform
lidt over i data skalering på trafik ihvertfald. 
